...
import { initDB, getCategories, getTransactions, addTransaction, updateBudget, addCategory, deleteTransaction, deleteCategory, updateTransaction, updateCategory, generateCSV, importCSV, getGoals, addGoal, updateGoal, deleteGoal, getSettings, updateSettings } from './database';
...
app.whenReady().then(() => {
  ...
  ipcMain.handle('update-settings', (_event, settings) => updateSettings(settings));
